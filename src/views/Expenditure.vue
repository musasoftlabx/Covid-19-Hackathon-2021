                ...
                <div>
                  ...
                  <div v-if="dataset.length >= 6">
                    ...
                    <v-row no-gutters align="center">
                      <span class="grey--text">Expenses per page</span>
                      <v-menu offset-y>
                              ...
                              <v-row no-gutters>
                                ...
                                <v-col cols="11">
                                  ...
                                  <v-chip
                                    ...
                                    >Amount: KSh
                                    {{
                                      item.expending_body.toLocaleString()
                                    }}</v-chip
                                  >
                                  <v-chip-group
                                    column
